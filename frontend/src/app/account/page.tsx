      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8">
        ...
        <div className="space-y-6">
          <div className="flex items-start gap-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
            ...
            <div>
              <p className="text-sm text-gray-600 dark:text-gray-400">{t.account.name}</p>
          ...
          <div className="flex items-start gap-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
            ...
            <div>
              <p className="text-sm text-gray-600 dark:text-gray-400">{t.account.email}</p>
          ...
          <div className="flex items-start gap-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
            ...
            <div>
              <p className="text-sm text-gray-600 dark:text-gray-400">{t.account.role}</p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
          <h2 className="text-xl font-semibold mb-4">{t.account.quickLinks}</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <a href="/prescriptions" className="p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:border-primary-600 transition-colors">
              <h3 className="font-semibold mb-1">{t.account.myPrescriptions}</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">{t.account.myPrescriptionsDesc}</p>
            </a>
            <a href="/orders" className="p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:border-primary-600 transition-colors">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">{t.account.orderHistoryDesc}</p>
            </a>
          </div>
        </div>
      </div>
